...
class CommonSearch(object):
    ...
    def __init__(self, search_for=None, page=None, page_size=10, limit=None, offset=None, order_direction='desc', institution=None, published_since=None, modified_since=None, group=None, _configuration=None):  # noqa: E501

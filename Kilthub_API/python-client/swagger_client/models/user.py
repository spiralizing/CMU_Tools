...
class User(object):
    ...
    def __init__(self, id=None, first_name=None, last_name=None, name=None, is_active=None, url_name=None, is_public=None, job_title=None, orcid_id=None, _configuration=None):  # noqa: E501

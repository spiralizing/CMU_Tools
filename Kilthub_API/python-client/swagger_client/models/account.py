...
class Account(object):
    ...
    def pending_quota_request(self, pending_quota_request):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and pending_quota_request is None:
            raise ValueError("Invalid value for `pending_quota_request`, must not be `None`")  # noqa: E501
    ...
    def maximum_file_size(self, maximum_file_size):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and maximum_file_size is None:
            raise ValueError("Invalid value for `maximum_file_size`, must not be `None`")  # noqa: E501

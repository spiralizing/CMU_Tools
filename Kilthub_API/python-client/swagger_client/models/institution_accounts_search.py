...
class InstitutionAccountsSearch(object):
    ...
    def __init__(self, search_for=None, is_active=None, page=None, page_size=10, limit=None, offset=None, institution_user_id=None, email=None, _configuration=None):  # noqa: E501
    ...
    def is_active(self, is_active):
        ...
        if (self._configuration.client_side_validation and
                is_active is not None and is_active > 1):  # noqa: E501
            raise ValueError("Invalid value for `is_active`, must be a value less than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                is_active is not None and is_active < 0):  # noqa: E501
